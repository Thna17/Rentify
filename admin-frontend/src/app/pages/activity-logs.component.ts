  ...
  @if (d.ready()) {
    ...
    <div class="card card-pad">
      @for (l of rows(); track l.id) {
        ...
        <div class="empty">No log entries for this filter.</div>
      }
    </div>
  } @else {
