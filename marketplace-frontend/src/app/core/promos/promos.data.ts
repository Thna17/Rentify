...
export const PROMO_SLOTS: {
  ...
  smartphones: {
    ...
    text: 'Explore latest flagship devices and official accessories from verified Cambodian stores.',
    ...
    perks: [
      ...
      'Same-day Delivery in PP',
      '0% Installment Available',
    ],
    kicker: 'Direct from verified phone retailers',
  },
};
