      ...
      <SidebarGroupContent className="flex flex-col gap-2">
        <SidebarMenu>
          <SidebarMenuItem className="flex items-center gap-2 mb-2">
            <Button className="bg-gradient-to-r from-primary to-primary/80 text-primary-foreground hover:from-primary/90 hover:to-primary/70 w-full justify-start h-10 transition-all duration-300 shadow-md hover:shadow-lg rounded-lg">
          ...
          {items.map((item) => (
            <React.Fragment key={item.name}>
              ...
              {item.hasSubmenu && expandedItems[item.path] && (
                <SidebarMenuItem>
                  <div className="ml-6 pl-2 border-l border-gray-200/50">
                    <SidebarMenu>
