...
export function SiteHeader({ currentTab, onSidebarToggle, userData }) {
  ...
  return (
    <header className="flex h-16 shrink-0 items-center gap-4 border-b bg-gradient-to-b from-background to-background/95 text-foreground  border-gray-200 shadow-sm px-6">
