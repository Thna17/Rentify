...
declare module '@rentify/apis';
declare module '@rentify/utils';
declare module 'redux-persist/integration/react';
declare module '@rentify/shared/ui/components/ReusableTable';
declare module '@rentify/shared/ui/components/StatusTabs';
