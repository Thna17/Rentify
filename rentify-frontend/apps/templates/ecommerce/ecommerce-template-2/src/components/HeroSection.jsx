...
const PRESET_IMAGES = [
  { label: 'High-Tech Audio & Setup', url: 'https://images.unsplash.com/photo-1550009158-9ebf69173e03?w=1600&auto=format&fit=crop&q=80' },
  { label: 'Studio ANC Headphones', url: 'https://images.unsplash.com/photo-1505740420928-5e560c06d30e?w=1600&auto=format&fit=crop&q=80' },
  { label: 'Titanium Smartwatch', url: 'https://images.unsplash.com/photo-1523275335684-37898b6baf30?w=1600&auto=format&fit=crop&q=80' },
  { label: 'Mechanical Keyboard Setup', url: 'https://images.unsplash.com/photo-1587829741301-dc798b83add3?w=1600&auto=format&fit=crop&q=80' },
];
        ...
        <div className="flex h-full flex-col items-center justify-center p-6 text-center border-2 border-dashed border-border/80 rounded-2xl">
          ...
          <p className="mt-1 max-w-sm text-sm text-muted-foreground">
            {isOwner
              ...
              : 'Discover cutting-edge gadgets and computing essentials.'}
          </p>
          {isOwner && (
        ...
        <Tabs value={tab} onValueChange={setTab} className="mt-2">
          ...
          <TabsContent value="url" className="space-y-4 pt-4">
            <div className="space-y-2">
              <Label htmlFor="tech-image-url">Image URL</Label>
              <Input
                id="tech-image-url"
            ...
            <div>
              <p className="text-xs font-medium text-muted-foreground mb-2">Or select a high-tech preset:</p>
